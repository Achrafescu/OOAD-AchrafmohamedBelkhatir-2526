...
namespace CLHelpdesk
{
    public class SoftwareTicket : Ticket
    {
        ...
        public SoftwareTicket(int id, string titel, Medewerker melder, TicketPrioriteit prioriteit, DateTime datumAangemaakt, string toestel)
        ...
        public override string ToString()
        {
            ...
            return string.Format("[{0}] {1} - {2} (Software)", status, Id, Titel);
        }
    }
}
