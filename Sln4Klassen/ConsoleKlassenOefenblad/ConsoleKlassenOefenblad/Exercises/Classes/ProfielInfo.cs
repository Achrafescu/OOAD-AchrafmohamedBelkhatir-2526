namespace ConsoleKlassenOefenblad.Exercises.Classes
{
    public class ProfielInfo
    {
        ...
        public bool IsVolledig
        {
            get
            {
                return !string.IsNullOrWhiteSpace(Voornaam) &&
                       ...
                       !string.IsNullOrWhiteSpace(Biografie) &&
        ...
        public ProfielInfo(int id, string gebruikersnaam, string email)
        {
            ...
            Email = email;
            AanmaakDatum = DateTime.Now; // automatisch invullen bij aanmaak
        }
        ...
        {
            string publiekStatus = IsPubliek ? "publiek" : "privé";

            return $"{Gebruikersnaam} - {publiekStatus}";
        }
    }
}
