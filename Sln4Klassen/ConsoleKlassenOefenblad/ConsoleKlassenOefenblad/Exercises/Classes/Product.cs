...
internal class Product
{
    ...
    // ...
    private string IsInVoorraadString = "";
    public override string ToString()
    {
        if (IsInVoorraad)
        {
            IsInVoorraadString = "in voorraad";
        }
        else
        {
            IsInVoorraadString = "niet in voorraad";
        }
        return $"[{ProductId}] - {PrijsMetKorting:c} | {IsInVoorraadString}";
    }
